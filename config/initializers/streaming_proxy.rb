...
#   config.streaming_proxy.num_retries_on_5xx = 1                                     # 0 by default
...
#   end
#   config.middleware.use Rack::StreamingProxy::Proxy do |request|
#     if request.path.start_with?('/api/manifest/stream/m3u8')
#       proxy_path = request.path.sub %r{^/api/manifest/stream/m3u8/}, ''
#       "http://#{proxy_path}"
#     end
#   end
# end